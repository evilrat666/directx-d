...
{
    UINT                       Width             = D3DX11_DEFAULT;
    UINT                       Height            = D3DX11_DEFAULT;
    UINT                       Depth             = D3DX11_DEFAULT;
    UINT                       FirstMipLevel     = D3DX11_DEFAULT;
    UINT                       MipLevels         = D3DX11_DEFAULT;
    D3D11_USAGE                Usage             = cast(D3D11_USAGE) D3DX11_DEFAULT;
    UINT                       BindFlags         = D3DX11_DEFAULT;
    UINT                       CpuAccessFlags    = D3DX11_DEFAULT;
    UINT                       MiscFlags         = D3DX11_DEFAULT;
    DXGI_FORMAT                Format            = DXGI_FORMAT_FROM_FILE;
    UINT                       Filter            = D3DX11_DEFAULT;
    UINT                       MipFilter         = D3DX11_DEFAULT;
...
alias D3DX11GetImageInfoFromFileW D3DX11GetImageInfoFromFile;
...
alias D3DX11GetImageInfoFromResourceW D3DX11GetImageInfoFromResource;
...
alias D3DX11CreateShaderResourceViewFromFileW D3DX11CreateShaderResourceViewFromFile;
...
alias D3DX11CreateTextureFromFileW D3DX11CreateTextureFromFile;
...
alias D3DX11CreateShaderResourceViewFromResourceW D3DX11CreateShaderResourceViewFromResource;
...
alias D3DX11CreateTextureFromResourceW D3DX11CreateTextureFromResource;
...
struct D3DX11_TEXTURE_LOAD_INFO
{
    ...
    UINT            SrcFirstMip;
    UINT            DstFirstMip;
    UINT            NumMips               = D3DX11_DEFAULT;
    UINT            SrcFirstElement;
    UINT            DstFirstElement;
    UINT            NumElements           = D3DX11_DEFAULT;
    UINT            Filter                = D3DX11_DEFAULT;
    UINT            MipFilter             = D3DX11_DEFAULT;
}
...
alias D3DX11SaveTextureToFileW D3DX11SaveTextureToFile;
