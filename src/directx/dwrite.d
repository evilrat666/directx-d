...
// Dword:   0x706D6363
// 
UINT32 DWRITE_MAKE_OPENTYPE_TAG(alias a, alias b, alias c, alias d)()
{
	return 
		(cast(UINT32)(cast(UINT8)d << 24)) |
		(cast(UINT32)(cast(UINT8)c << 16)) |
		(cast(UINT32)(cast(UINT8)b << 8 )) |
		(cast(UINT32)(cast(UINT8)a      ));
}
...
interface IDWriteFactory : IUnknown
{
    ...
    HRESULT CreateFontFace(
        ...
        const(IDWriteFontFile)* fontFiles,
        UINT32 faceIndex,
...
/// component.
/// </remarks>
export extern(C) HRESULT DWriteCreateFactory(
...
HRESULT MAKE_DWRITE_HR(alias sev, T)(T code) {
	return MAKE_HRESULT(sev, FACILITY_DWRITE, DWRITE_ERR_BASE+code);
}

HRESULT MAKE_DWRITE_HR_ERR(T)(T code) {
	return MAKE_DWRITE_HR(1, code);
}
