...
alias uint D3D12_COMMAND_LIST_TYPE;
...
alias uint D3D12_COMMAND_QUEUE_FLAGS;
enum : D3D12_COMMAND_QUEUE_FLAGS {
    D3D12_COMMAND_QUEUE_FLAG_NONE                = 0,
    D3D12_COMMAND_QUEUE_FLAG_DISABLE_GPU_TIMEOUT = 0x1
}

alias uint D3D12_COMMAND_QUEUE_PRIORITY;
...
alias uint D3D12_PRIMITIVE_TOPOLOGY_TYPE;
...
alias uint D3D12_INPUT_CLASSIFICATION;
...
alias uint D3D12_COMPARISON_FUNC;
...
alias uint D3D12_DEPTH_WRITE_MASK;
enum : D3D12_DEPTH_WRITE_MASK {
    D3D12_DEPTH_WRITE_MASK_ZERO = 0,
    D3D12_DEPTH_WRITE_MASK_ALL  = 1
}

alias uint D3D12_STENCIL_OP;
...
alias uint D3D12_COLOR_WRITE_ENABLE;
...
alias uint D3D12_CONSERVATIVE_RASTERIZATION_MODE;
...
alias uint D3D12_INDEX_BUFFER_STRIP_CUT_VALUE;
...
alias uint D3D12_PIPELINE_STATE_FLAGS;
...
alias uint D3D12_SHADER_MIN_PRECISION_SUPPORT;
...
alias uint D3D12_TILED_RESOURCES_TIER;
...
alias uint D3D12_RESOURCE_BINDING_TIER;
...
alias uint D3D12_CONSERVATIVE_RASTERIZATION_TIER;
...
alias uint D3D12_FORMAT_SUPPORT1;
...
alias uint D3D12_FORMAT_SUPPORT2;
...
alias uint D3D12_RESOURCE_HEAP_TIER;
...
alias uint D3D12_CPU_PAGE_PROPERTY;
...
alias uint D3D12_RESOURCE_DIMENSION;
...
alias uint D3D12_TEXTURE_LAYOUT;
...
alias uint D3D12_RESOURCE_FLAGS;
...
alias uint D3D12_TILE_RANGE_FLAGS;
...
alias uint D3D12_TILE_MAPPING_FLAGS;
enum : D3D12_TILE_MAPPING_FLAGS {
    D3D12_TILE_MAPPING_FLAG_NONE      = 0,
    D3D12_TILE_MAPPING_FLAG_NO_HAZARD = 0x1
}

alias uint D3D12_TILE_COPY_FLAGS;
...
alias uint D3D12_RESOURCE_STATES;
...
alias uint D3D12_RESOURCE_BARRIER_TYPE;
...
alias uint D3D12_RESOURCE_BARRIER_FLAGS;
...
alias uint D3D12_TEXTURE_COPY_TYPE;
...
alias uint D3D12_SHADER_COMPONENT_MAPPING;
...
alias uint D3D12_BUFFER_SRV_FLAGS;
...
alias uint D3D12_SRV_DIMENSION;
...
alias uint D3D12_FILTER_TYPE;
enum : D3D12_FILTER_TYPE {
    D3D12_FILTER_TYPE_POINT  = 0,
    D3D12_FILTER_TYPE_LINEAR = 1
}

alias uint D3D12_FILTER_REDUCTION_TYPE;
...
alias uint D3D12_TEXTURE_ADDRESS_MODE;
...
alias uint D3D12_UAV_DIMENSION;
...
alias uint D3D12_RTV_DIMENSION;
...
alias uint D3D12_DSV_DIMENSION;
...
alias uint D3D12_CLEAR_FLAGS;
enum : D3D12_CLEAR_FLAGS {
    D3D12_CLEAR_FLAG_DEPTH   = 0x1,
    D3D12_CLEAR_FLAG_STENCIL = 0x2
}

alias uint D3D12_FENCE_FLAGS;
...
alias uint D3D12_DESCRIPTOR_HEAP_TYPE;
...
alias uint D3D12_DESCRIPTOR_HEAP_FLAGS;
...
alias uint D3D12_DESCRIPTOR_RANGE_TYPE;
...
alias uint D3D12_SHADER_VISIBILITY;
...
alias uint D3D12_ROOT_PARAMETER_TYPE;
...
alias uint D3D12_ROOT_SIGNATURE_FLAGS;
...
alias uint D3D12_STATIC_BORDER_COLOR;
...
alias uint D3D_ROOT_SIGNATURE_VERSION;
...
alias uint D3D12_QUERY_HEAP_TYPE;
...
alias uint D3D12_PREDICATION_OP;
...
alias uint D3D12_INDIRECT_ARGUMENT_TYPE;
