...
enum XAPO_E_FORMAT_UNSUPPORTED = MAKE_HRESULT(SEVERITY_ERROR, 0x897, 0x01);
...
enum DXUTERR_INCORRECTVERSION =        MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x0909);
...
debug{
enum DXTRACE_MSG(string str, wstring file = __FILE__, ulong line = __LINE__) 
{
        return DXTrace( file, line, 0, str, false );
}
enum DXTRACE_ERR(string str, HRESULT hr, wstring file = __FILE__, ulong line = __LINE__)
{
        return DXTrace(file, line, hr, str, false );
}
enum DXTRACE_ERR_MSGBOX(string str, HRESULT hr, wstring file = __FILE__, ulong line = __LINE__)
{
