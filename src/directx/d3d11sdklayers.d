...
enum D3D11_DEBUG_FEATURE_ALWAYS_DISCARD_OFFERED_RESOURCE    = ( 0x8 );
enum D3D11_DEBUG_FEATURE_NEVER_DISCARD_OFFERED_RESOURCE     = ( 0x10 );
enum D3D11_DEBUG_FEATURE_AVOID_BEHAVIOR_CHANGING_DEBUG_AIDS = ( 0x40 );
enum D3D11_DEBUG_FEATURE_DISABLE_TILED_RESOURCE_MAPPING_TRACKING_AND_VALIDATION = ( 0x80 );
...
extern (C++) interface ID3D11Debug : IUnknown {
...
extern (C++) interface ID3D11SwitchToRef : IUnknown {
    BOOL SetUseRef(BOOL UseRef);
    BOOL GetUseRef();
}

alias DWORD D3D11_SHADER_TRACKING_RESOURCE_TYPE;
...
alias DWORD D3D11_SHADER_TRACKING_OPTION;
...
extern (C++) interface ID3D11TracingDevice : IUnknown {
...
extern (C++) interface ID3D11InfoQueue : IUnknown {
    ...
    HRESULT AddMessage(D3D11_MESSAGE_CATEGORY Category, D3D11_MESSAGE_SEVERITY Severity, D3D11_MESSAGE_ID ID, LPCSTR pDescription);
