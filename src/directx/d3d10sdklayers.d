...
enum D3D10_DEBUG_FEATURE_FLUSH_PER_RENDER_OP = ( 0x1 );
enum D3D10_DEBUG_FEATURE_FINISH_PER_RENDER_OP = ( 0x2 );
enum D3D10_DEBUG_FEATURE_PRESENT_PER_RENDER_OP = ( 0x4 );

mixin(uuid!(ID3D10Debug, "9B7E4E01-342C-4106-A19F-4F2704F689F0"));
extern (C++) interface ID3D10Debug : IUnknown {
...
mixin(uuid!(ID3D10SwitchToRef, "9B7E4E02-342C-4106-A19F-4F2704F689F0"));
extern (C++) interface ID3D10SwitchToRef : IUnknown {
...
alias DWORD D3D10_MESSAGE_CATEGORY;
...
alias DWORD D3D10_MESSAGE_SEVERITY;
...
enum D3D10_INFO_QUEUE_DEFAULT_MESSAGE_COUNT_LIMIT = 1024;

mixin(uuid!(ID3D10InfoQueue, "1b940b17-2642-4d1f-ab1f-b99bad0c395f"));
extern (C++) interface ID3D10InfoQueue : IUnknown {
    HRESULT SetMessageCountLimit(UINT64 MessageCountLimit);
    void ClearStoredMessages();
    HRESULT GetMessage(UINT64 MessageIndex, D3D10_MESSAGE* pMessage, SIZE_T* pMessageByteLength);
    ...
    HRESULT AddMessage(
        ...
        D3D10_MESSAGE_ID ID,
        LPCSTR pDescription);
    HRESULT AddApplicationMessage(D3D10_MESSAGE_SEVERITY Severity, LPCSTR pDescription);
